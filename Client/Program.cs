...
using ERacuniNovi.Shared.Validation;
...
namespace ERacuniNovi.Client
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            #region Dodavanje servisa za registraciju i loginovanje
            builder.Services.AddSingleton(servis =>
    {
        ...
        return new ERacuniProtoServis.ERacuniProtoServisClient(Kanal);

    }); 
            #endregion

            #region Dodavanje BillProtoServisa
            builder.Services.AddSingleton(servis =>
                {
                    string URI = servis.GetRequiredService<NavigationManager>().BaseUri;
                    ...
                    return new BillProtoServis.BillProtoServisClient(Kanal);

                }); 
            #endregion

            builder.Services.AddTransient<ConvertGRPC>(); //servis za konvertovanje 

            builder.Services.AddApiAuthorization()
                .AddAccountClaimsPrincipalFactory<RolesFactory>();
            builder.Services.AddTransient<IValidator<Bill>, ValidationBill>(); //validacija za bill
